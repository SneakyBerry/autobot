...
Пример: /reg A111AA777 (принимается латиница, кириллица и буквы любого регистра)

Если ты хочешь добавить чей-то номер из-под стекла в базу данных, напиши /add_phone + номер машины + номер телефона.
Пример: /add_phone A111AA777 (в номере авто принимается латиница, кириллица и буквы любого регистра), номер телефона должен начинаться с 7 или 8, далее 10 цифр номера телефона

Если ты хочешь найти владельца по номеру машины — напиши /search + номер машины.
Пример: /search A111AA777 (принимается латиница, кириллица и буквы любого регистра)
